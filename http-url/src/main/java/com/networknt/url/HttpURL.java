...
public class HttpURL implements Serializable {
  private static long serialVersionUID=-8886393027925815099L;
  /** 
 ...
 */
  ...
  /** 
 * Gets the URL port. If the protocol is other than <code>http</code> or <code>https</code>, the port is -1 when not specified.
 * @return the URL port
 */
  public int getPort(){
    return port;
 ...
 */
  ...
  /** 
 * Gets the root of this HttpUrl. That is the left part of a URL up to and including the host name. A <code>null</code> or empty string returns a <code>null</code> document root.
 ...
 */
  ...
  /** 
 * <p>Gets the root of a URL. That is the left part of a URL up to and including the host name. A <code>null</code> or empty string returns a <code>null</code> document root. This method is a short form of:<br> <code>new HttpURL("http://example.com/path").getRoot();</code> </p>
 * @param url a URL string
 * @return left part of a URL up to (and including the host name
 * @since 1.8.0
 */
 ...
 */
  ...
  /** 
 * <p>URL-Encodes a URL path.  The entire string supplied is assumed to be a URL path. Unsafe characters are percent-encoded using UTF-8 (as specified by W3C standard).
 ...
 */
 ...
 else       if (CharUtils.isAsciiAlphanumeric(ch) || ".-_~!$&'()*+,;=:@/%".indexOf(ch) != -1) {
        sb.append(ch);
      }
 else {
        byte[] bytes;
 ...
 */
  ...
  @Override public boolean equals(  Object o){
    ...
    return port == httpURL.port && Objects.equals(host,httpURL.host) && Objects.equals(path,httpURL.path) && Objects.equals(protocol,httpURL.protocol) && Objects.equals(encoding,httpURL.encoding) && Objects.equals(fragment,httpURL.fragment);
  }
