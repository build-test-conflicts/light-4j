...
public final class SendToLocalInfluxDB {
  ...
  public static InfluxDbReporter startInfluxDbReporter(  MetricRegistry registry) throws Exception {
  ...
  public static ConsoleReporter startConsoleReporter(  MetricRegistry registry) throws Exception {
